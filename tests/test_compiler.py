...
from qsot.core.compiler import run, check_axiom1_linearity, check_axiom2_conditionability, KrausChannel
...
def test_parametrized_velocities(tmp_path, sample_rho0, damping_channel, velocity):
