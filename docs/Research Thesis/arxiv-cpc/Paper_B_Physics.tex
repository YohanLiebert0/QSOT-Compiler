...
We compute $\sigma_C$ and $\sigma_N$ using Monte Carlo resampling over $N_{MC}$ runs (set $N_{MC} = [FILL]$ in the released benchmark script).
...
\bibitem{QuTiP5} QuTiP 5 Project, \textit{The Quantum Toolbox in Python} (2023). https://qutip.org/.
\bibitem{RelExp2020} [PLACEHOLDER] Recent experimental demonstrations in relativistic quantum information (2020--2024); insert specific citations here.
\end{thebibliography}
